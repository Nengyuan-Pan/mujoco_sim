...
def main() -> None:
    ...
    cache_path = Path(__file__).resolve().parent.parent / "results" / f"perturb_cache_s{args.seed}.npz"
    ...
    plt.tight_layout()
    out_path = Path(__file__).resolve().parent.parent / "results" / f"perturb_compare_s{args.seed}.png"
