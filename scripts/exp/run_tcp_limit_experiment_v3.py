...
用法:
    python scripts/exp/run_tcp_limit_experiment_v3.py --ball-speed 8 --seed 0
    python scripts/exp/run_tcp_limit_experiment_v3.py --ball-speed 8 --seed 0 --viewer
    python scripts/exp/run_tcp_limit_experiment_v3.py --ball-speed 8 --seed 0 --max-tcp 2.0
"""
import sys
import argparse
