"""RM-65 V6: 满秩 Q_v + 来球反方向 + 终端偏移 + TubeHittingCostWrapper + PD 随挥。
...
def main() -> None:
    ...
    tube_cfg = TubeConfig(
        ...
        Q_p_tube=0.0,  # v6: 走廊代价权重清零
        Q_v_tube=0.0,  # v6: 走廊代价权重清零
        Q_n_tube=0.0,  # v6: 走廊代价权重清零
        tube_cost_ratio=0.0,  # v6: 不再使用 tube wrapper，比例无关
        softmin_beta=args.softmin_beta,
        use_softmin_terminal=True,  # v6: 始终启用 softmin
    )
